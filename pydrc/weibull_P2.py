...
class WeibullP2Model:
    ...
    def fit(self, x=None, y=None, param_constraint=None, n_dec=6):
        """Estimate parameters (b, e) of the two-parameter Weibull model from data"""
        ...
        params, covariance = curve_fit(self.weibull_P2, x_data, y_data, bounds=mod_bounds)
        ...
        summary_params = pd.DataFrame({'Parameter': ['b', 'e'],
    ...
    def predict(self, x=None):
        ...
        if x is None:
            ...
            x_pred = x
        b, e = self.params
        return self.weibull_P2(x_pred, b, e)
