...
class ARModel:
    ...
    def fit(self, x=None, y=None, param_constraint=None, n_dec=6):
        """Estimate parameters (c, d, e) of the asymptotic regression model from data"""
        ...
        params, covariance = curve_fit(self.ar_model, x_data, y_data, bounds=mod_bounds)
    ...
    def predict(self, x=None):
        ...
        if x is None:
            ...
            x_pred = x
        c, d, e = self.params
        return self.ar_model(x_pred, c, d, e)
