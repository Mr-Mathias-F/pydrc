...
class WeibullP3Model:
    ...
    def fit(self, x=None, y=None, param_constraint=None, n_dec=6):
        """Estimate parameters (b, d, e) of the three-parameter Weibull model from data"""
        ...
        params, covariance = curve_fit(self.weibull_P3, x_data, y_data, bounds=mod_bounds)
        ...
        summary_params = pd.DataFrame({'Parameter': ['b', 'd', 'e'],
    ...
    def predict(self, x=None):
        ...
        if x is None:
            ...
            x_pred = x
        b, d, e = self.params
        return self.weibull_P3(x_pred, b, d, e)
