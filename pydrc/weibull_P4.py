...
class WeibullP4Model:
    ...
    def fit(self, x=None, y=None, param_constraint=None, n_dec=6):
        """Estimate parameters (b, c, d, e) of the four-parameter Weibull model from data"""
        ...
        params, covariance = curve_fit(self.weibull_P4, x_data, y_data, bounds=mod_bounds)
    ...
    def predict(self, x=None):
        ...
        if x is None:
            ...
            x_pred = x
        b, c, d, e = self.params
        return self.weibull_P4(x_pred, b, c, d, e)
