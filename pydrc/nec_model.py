...
class NecModel:
    ...
    def fit(self, x=None, y=None, param_constraint=None, n_dec=6):
        """Estimate parameters (c, b, d, e, b_2, d_2, e_2, I) of the NEC model from data"""
        ...
        params, covariance = curve_fit(self.nec_model, x_data, y_data, bounds=mod_bounds)
        ...
        summary_params = pd.DataFrame({'Parameter': ['c', 'b', 'd', 'e', 'b_2', 'd_2', 'e_2', 'I'],
    ...
    def predict(self, x=None):
        ...
        return self.nec_model(x_pred, c, b, d, e, b_2, d_2, e_2, I)
