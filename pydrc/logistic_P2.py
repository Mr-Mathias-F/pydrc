...
class LogisticP2Model:
    ...
    def fit(self, x=None, y=None, param_constraint=None, n_dec=6):
        """Estimate parameters (b, e) of the log-logistic curve from data"""
        ...
        params, covariance = curve_fit(self.logistic_P2, x_data, y_data, bounds=mod_bounds)
    ...
    def predict(self, x=None):
        ...
        if x is None:
            ...
            x_pred = x
        b, e = self.params
        return self.logistic_P2(x_pred, b, e)
