...
class ExponentialDecayModel:
    ...
    def fit(self, x=None, y=None, param_constraint=None, n_dec=6):
        """Estimate parameters (c, d, e) of the exponential decay model from data"""
        ...
        params, covariance = curve_fit(self.exponential_decay, x_data, y_data, bounds=mod_bounds)
        ...
        summary_params = pd.DataFrame({'Parameter': ['c', 'd', 'e'],
    ...
    def predict(self, x=None):
        ...
        if x is None:
            ...
            x_pred = x
        c, d, e = self.params
        return self.exponential_decay(x_pred, c, d, e)
