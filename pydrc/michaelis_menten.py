...
class MichaelisMentenModel:
    ...
    def fit(self, x=None, y=None, param_constraint=None, n_dec=6):
        """Estimate parameters (v_max, k_m) of the Michaelis-Menten model from data"""
        ...
        params, covariance = curve_fit(self.michaelis_menten, x_data, y_data, bounds=mod_bounds)
        ...
        summary_params = pd.DataFrame({'Parameter': ['v_max', 'k_m'],
    ...
    def predict(self, x=None):
        ...
        return self.michaelis_menten(x_pred, v_max, k_m)
